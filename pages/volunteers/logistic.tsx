...
export default function LogisticVolunteers() {
  ...
  useEffect(() => {
    async function fetchLogisticVolunteers() {
      ...
      try {
        ...
        console.error("Error fetching logistic volunteers:", err);
      }
      setLoading(false);
    }
    fetchLogisticVolunteers();
  }, []);
    ...
    <div className={styles.container}>
      ...
      <main className={styles.mainContent}>
        ...
        <div className={styles.pageHeader}>
          <div>
            <h1 className={styles.headerTitle}>Logistic Applications</h1>
        ...
        <div className={styles.statsGrid}>
          <StatCard label="Total Logistic Applications" value={stats.total.toString()} icon="📦" />
        ...
        <div className={styles.applicationsSection}>
          <h2 className={styles.sectionTitle}>Logistic Volunteer Applications</h2>
          {paginatedVolunteers.length > 0 ? (
            ...
            <div className={styles.emptyState}>
              <p className={styles.emptyStateText}>No logistic applications found</p>
            </div>
          )}
        </div>
      </main>
