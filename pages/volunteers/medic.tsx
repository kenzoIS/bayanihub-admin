  ...
  useEffect(() => {
    async function fetchMedicVolunteers() {
      ...
      try {
        ...
        console.error("Error fetching medic volunteers:", err);
      }
      setLoading(false);
    }
    fetchMedicVolunteers();
  }, []);
